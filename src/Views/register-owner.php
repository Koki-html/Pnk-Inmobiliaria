...
$pageTitle = 'Registro | PNK Inmobiliaria';
$pageStyle = 'register-owner.css';
    ...
    <section class="register-panel">
        ...
        <div class="register-header">
            ...
            <div>
                ...
                <h1>
                    Regístrate como Propietario o Gestor Inmobiliario Free
                </h1>

                <p>
                    Selecciona el tipo de cuenta y completa tus datos básicos.
                    El propietario quedará en estado pendiente hasta la verificación del administrador.
                </p>
            </div>
        ...
        <div class="register-tabs" role="tablist">
            ...
            <button
                type="button"
                class="register-tab"
                data-target="manager-form"
            >
                Registrarme como GESTOR INMOBILIARIO FREE
            </button>
            ...
            >
                ...
                <div class="register-grid">
                    ...
                    <div class="form-group full-width">
                        ...
                        <label for="owner-property-number">
                            N° de propiedad según registro de Bienes Raíces
                        </label>

                        <input
                            id="owner-property-number"
                            class="form-input"
                            type="text"
            ...
            >
                ...
                <div class="register-grid">
                    ...
                    <div class="form-group full-width">
                        ...
                        <label for="manager-backgrounds">
                            Certificado de antecedentes
                        </label>

                        <input
                            id="manager-backgrounds"
                            class="form-file"
                            type="file"
...
const tabs =
    document.querySelectorAll('.register-tab');

const forms =
    document.querySelectorAll('.register-form');
        ...
        Swal.fire({
            ...
            html: `
                ...
                <p>
                    ...
                    deberá revisar y aprobar tu solicitud
                ...
                <p>
                    Recibirás una respuesta una vez que tu
                    cuenta sea validada.
                </p>
            `,
